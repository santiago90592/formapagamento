...
<head>
  ...
  <!-- renderizara estilos especificos da view que estender esse layout-->
...
<body>
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?php echo site_url('admin/utilizadores');?>">
      ...
      <!-- renderizara conteudo especificos da view que estender esse layout-->
  ...
  <!-- renderizara scripts especificos da view que estender esse layout-->
